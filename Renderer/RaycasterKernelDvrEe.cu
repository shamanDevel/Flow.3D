#define RAYCASTER_ENABLE_DVR_EE

#include "RaycasterKernelParams.h"
#ifdef RAYCASTER_ENABLE_DVR_EE
#include "cudaUtil.h"
...
void raycasterKernelDvrEe(RaycasterKernelParams& params)
{
	...
	switch(params.filterMode) {
		...
		case TEXTURE_FILTER_LINEAR : RAYCASTER_COMPUTE_SWITCH_RT(dvrEeKernel, TEXTURE_FILTER_LINEAR, COLOR_MODE_UI); break;
		#endif
		#ifdef RAYCASTER_ENABLE_CUBIC
		case TEXTURE_FILTER_CUBIC  : RAYCASTER_COMPUTE_SWITCH_RT(dvrEeKernel, TEXTURE_FILTER_CUBIC,  COLOR_MODE_UI); break;
		#endif
	}
#endif
}
