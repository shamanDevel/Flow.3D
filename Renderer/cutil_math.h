...
{
	return make_float2(fmin(a.x,b.x), fmin(a.y,b.y));
}
...
inline __host__ __device__ float2 fmax(float2 a, float b)
{
	return make_float2(fmax(a.x,b), fmax(a.y,b));
}
inline __host__ __device__ float3 fmax(float3 a, float3 b)
{
	return make_float3(fmax(a.x,b.x), fmax(a.y,b.y), fmax(a.z,b.z));
}
inline __host__ __device__ float3 fmax(float3 a, float b)
{
...
inline __host__ __device__ float4 fmax(float4 a, float b)
{
...
inline __host__ __device__ float lengthSq(float2 v)
{
    return dot(v, v);
}
...
inline __host__ __device__ float lengthSq(float4 v)
{
    return dot(v, v);
}
...
inline __host__ __device__ float2 fmod(float2 a, float2 b)
{
    return make_float2(fmod(a.x, b.x), fmod(a.y, b.y));
}
inline __host__ __device__ float3 fmod(float3 a, float3 b)
{
    return make_float3(fmod(a.x, b.x), fmod(a.y, b.y), fmod(a.z, b.z));
}
inline __host__ __device__ float4 fmod(float4 a, float4 b)
{
    return make_float4(fmod(a.x, b.x), fmod(a.y, b.y), fmod(a.z, b.z), fmod(a.w, b.w));
}
